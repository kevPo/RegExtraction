...
(function($) {
	...
	var HighlightWithinTextarea = function($el, onInput, $el2) {
		this.$el = $el;
		this.$el2 = $el2;
	...
	$.fn.highlightWithinTextarea = function(onInput, $el2) {
		return this.each(function() {
			...
			highlightWithinTextarea = new HighlightWithinTextarea($this, onInput, $el2);
